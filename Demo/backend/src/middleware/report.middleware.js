...
var ReportMiddleware = /** @class */ (function () {
    function ReportMiddleware() {
    }
    ReportMiddleware.prototype.resolve = function () {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        // 控制器之后执行的逻辑
                        ctx.logger.info("Report in \"src/middleware/report.middleware.ts\", rt = ".concat(Date.now() - startTime, "ms"));
                        // 返回给上一个中间件的结果
    ...
    ReportMiddleware.getName = function () {
        return 'report';
    };
